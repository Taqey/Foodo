...
{
	public class MerchantOrderStrategy : IOrderStrategy
	{
		private readonly IMerchantOrderService _service;

		public MerchantOrderStrategy(IMerchantOrderService service)
		{
			_service = service;
		}
